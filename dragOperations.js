...
import { BlockElement, constructBlockData, constructGroupData, GroupElement, isRectContained, Transform, uuid } from "./block.js"
...
export let dragOperations = {
	...
	onpointerup: e => {
		...
		if (dragAction == 'making-block') {
			...
			addNode({x, y, width, height, color: '1',type: state.making_node, id: uuid(), data: {}})
		}
